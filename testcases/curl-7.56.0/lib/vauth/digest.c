...
{
    int i=0;
    for(i=0; i<len; i++) printf("%02x ", h[i]);
    printf("\n");
}
*/
                                              ...
                                              char **outptr, size_t *outlen)
{
  ...
  char *response = NULL;
  char *tmp = NULL;
  printf("Producing digest message\n");
  ...
  */
  ...
  md5this = (unsigned char *) aprintf("%st:%s", request, uripath);
  ...
  *outlen = strlen(response);
  printf("Producing digest message: complete\n");
